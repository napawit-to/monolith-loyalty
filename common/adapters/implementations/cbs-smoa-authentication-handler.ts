...
class CBSSMOAAuthenticationHandler implements RequestHandler {
    private errorCodes: Readonly<string[]>;

    constructor() {
        this.errorCodes = Config.getGlobal<string[]>(
            "third-party-services.cbs-smoa.authentication.error-codes", []
        );
    }
...
export default () => new CBSSMOAAuthenticationHandler();
